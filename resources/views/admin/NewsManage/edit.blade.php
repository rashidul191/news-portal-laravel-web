...
@section('content')
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <span class="breadcrumb-item active">Bangla Post Update Manage</span>
        </nav>
        <div class="sl-pagebody">
            <div class="container mt-3">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Bangla Post Update Form</h4>
                        <form action="{{ url('news/manage/' . $news->id) }}" method="post" enctype="multipart/form-data"
