...
@section('content')
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <span class="breadcrumb-item active">Bangla Post Manage</span>
        </nav>
        <div class="sl-pagebody">
            <div class="container mt-3">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><b>Bangla Post Manage</b></h4><br>
                        <div class="row">
                            <div class="col-sm-12 col-md-3">
                                <a href="{{ url('news/manage/create') }}"><button class="btn btn-primary">+Add
                                        New</button></a>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:150px;">
                                                        <div class="d-flex justify-content-center">
                                                            <a href="{{ url('news/manage/' . $item->id . '/edit') }}"
                                                                class="btn btn-primary mr-1">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </a>
                                                            <form id="deleteForm{{ $item->id }}"
                                                                action="{{ url('/news/manage/' . $item->id) }}" method="post">
                                                                @method('DELETE')
                                                                @csrf
