                                ...
                                <div class="my-custom-scrollbar">
                                    <div class="list-group">
                                        @foreach ($data['newsLatest'] as $nL)
                                            <a href="{{ url('news_details/' . $nL->id) }}" class="list-group-item news-item">
                                ...
                                <div class="my-custom-scrollbar">
                                    <div class="list-group">
                                        @foreach ($data['newsPopular'] as $nP)
                                            <a href="{{ url('news_details/' . $nP->id) }}" class="list-group-item news-item">
                                                <span class="news-icon">▶</span>
            ...
            {{-- <div id="first-cat" class="row m-b-1">
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat11']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat11']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat11Title->id) }}" class="list-group-item">{{
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat12']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat12']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat12Title->id) }}" class="list-group-item">{{
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat8']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat8']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="cat-body">
                            <div class="list-group no-margin">
                                ...
                                <a href="{{ url('news_details/' . $cat8Title->id) }}" class="list-group-item">{{
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat13']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat13']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat13Title->id) }}" class="list-group-item">{{
                    ...
                    <!--========================== facebook =============================-->
                    <div class="fb-page" data-href="https://www.facebook.com/profile.php?id=61573029878904"
                        data-tabs="timeline" data-width="280" data-height="148" data-small-header="false"
                        data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                        <blockquote cite="https://www.facebook.com/profile.php?id=61573029878904"
                            class="fb-xfbml-parse-ignore"><a
                                href="https://www.facebook.com/profile.php?id=61573029878904">Dhakapress24.com</a>
                        </blockquote>
                    </div>
                    <br>
                </div>
            ...
            {{-- <div id="first-cat" class="row m-b-1">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat14']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat14']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat14Title->id) }}" class="list-group-item">{{
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat15']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat15']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat15Title->id) }}" class="list-group-item">{{
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat16']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat16']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="cat-body">
                            <div class="list-group no-margin">
                                ...
                                <a href="{{ url('news_details/' . $cat16Title->id) }}" class="list-group-item">{{
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat17']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat17']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="cat-body">
                            <div class="list-group no-margin">
                                ...
                                <a href="{{ url('news_details/' . $cat17Title->id) }}" class="list-group-item">{{
            ...
            {{-- <div id="sixth-cat" class="row m-b-1">
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                    <div class="box-card p-b-0">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat18']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat18']->name }}
                                    </h4>
                                </a>
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat43']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat43']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat43Title->id) }}" class="list-group-item">{{
            ...
            {{-- <div id="first-cat" class="row m-b-1"> --}}
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat20']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat20']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat20Title->id) }}" class="list-group-item">{{
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat6']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat6']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat6Title->id) }}" class="list-group-item">{{
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat31']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat31']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat31Title->id) }}" class="list-group-item">{{
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat32']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat32']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat32Title->id) }}" class="list-group-item">{{
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat5']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat5']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="cat-body">
                            <div class="list-group no-margin">
                                ...
                                <a href="{{ url('news_details/' . $cat5Title->id) }}" class="list-group-item">{{
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat7']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat7']->name }}</h4>
                                </a>
                            </div>
                        ...
                        <div class="cat-body">
                            <div class="list-group no-margin">
                                ...
                                <a href="{{ url('news_details/' . $cat7Title->id) }}" class="list-group-item">{{
            ...
            {{-- <div id="fifth-cat" class="row m-b-1">
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat21']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat21']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat21Title->id) }}" class="list-group-item">{{
                    ...
                    <div class="box-card mt-2">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat24']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat24']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat24Title->id) }}" class="list-group-item">{{
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat23']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat23']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat23Title->id) }}" class="list-group-item">{{
                    ...
                    <div class="box-card mt-2">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat25']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat25']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat25Title->id) }}" class="list-group-item">{{
            ...
            {{-- <div id="first-cat" class="row m-b-1"> --}}
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat26']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat26']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat26Title->id) }}" class="list-group-item">{{
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat27']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat27']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat27Title->id) }}" class="list-group-item">{{
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat29']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat29']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="cat-body">
                            <div class="list-group no-margin">
                                ...
                                <a href="{{ url('news_details/' . $cat29Title->id) }}" class="list-group-item">{{
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat30']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat30']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="cat-body">
                            <div class="list-group no-margin">
                                ...
                                <a href="{{ url('news_details/' . $cat30Title->id) }}" class="list-group-item">{{
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat33']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat33']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="cat-body">
                            <div class="list-group no-margin">
                                ...
                                <a href="{{ url('news_details/' . $cat33Title->id) }}" class="list-group-item">{{
            ...
            {{-- <div id="fifth-cat" class="row m-b-1"> --}}
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat42']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat42']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat42Title->id) }}" class="list-group-item">{{
                    ...
                    <div class="box-card mt-2">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat37']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat37']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat37Title->id) }}" class="list-group-item">{{
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                    <div class="box-card p-b-0">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat36']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat36']->name }}
                                    </h4>
                                </a>
            ...
            {{-- <div id="eighth-cat" class="row m-b-1"> --}}
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat38']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat38']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat38Title->id) }}" class="list-group-item">{{
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat39']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat39']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat39Title->id) }}" class="list-group-item">{{
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat40']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat40']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat40Title->id) }}" class="list-group-item">{{
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat41']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat41']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat41Title->id) }}" class="list-group-item">{{
            ...
            {{-- <div id="eighth-cat" class="row m-b-1"> --}}
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat44']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat44']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat44Title->id) }}" class="list-group-item">{{
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat45']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat45']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat45Title->id) }}" class="list-group-item">{{
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat47']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat47']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat47Title->id) }}" class="list-group-item">{{
                ...
                {{-- <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="box-card">
                        <div class="article-box cat-box">
                            <div class="cat-header">
                                <a href="{{ url('category/' . $cat['cat48']->id) }}">
                                    <h4 class="cat-title">
                                        {{ $cat['cat48']->name }}
                                    </h4>
                                </a>
                        ...
                        <div class="list-group no-margin">
                            ...
                            <a href="{{ url('news_details/' . $cat48Title->id) }}" class="list-group-item">{{
