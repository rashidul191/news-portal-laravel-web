                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat11Title'] as $cat11Title)
                                <a href="{{ route('english_news_details', $cat11Title->id) }}"
                                    class="list-group-item">{{ $cat11Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat12Title'] as $cat12Title)
                                <a href="{{ route('english_news_details', $cat12Title->id) }}"
                                    class="list-group-item">{{ $cat12Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                        ...
                        <div class="cat-body">
                            <div class="list-group no-margin">
                                @foreach ($news['cat8Title'] as $cat8Title)
                                    <a href="{{ route('english_news_details', $cat8Title->id) }}"
                                        class="list-group-item">{{ $cat8Title->postTitle }}</a>
                                @endforeach
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat13Title'] as $cat13Title)
                                <a href="{{ route('english_news_details', $cat13Title->id) }}"
                                    class="list-group-item">{{ $cat13Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                    <div id="fb-root"></div>
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat14Title'] as $cat14Title)
                                <a href="{{ route('english_news_details', $cat14Title->id) }}"
                                    class="list-group-item">{{ $cat14Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat15Title'] as $cat15Title)
                                <a href="{{ route('english_news_details', $cat15Title->id) }}"
                                    class="list-group-item">{{ $cat15Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                        ...
                        <div class="cat-body">
                            <div class="list-group no-margin">
                                @foreach ($news['cat16Title'] as $cat16Title)
                                    <a href="{{ route('english_news_details', $cat16Title->id) }}"
                                        class="list-group-item">{{ $cat16Title->postTitle }}</a>
                                @endforeach
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="cat-body">
                            <div class="list-group no-margin">
                                @foreach ($news['cat17Title'] as $cat17Title)
                                    <a href="{{ route('english_news_details', $cat17Title->id) }}"
                                        class="list-group-item">{{ $cat17Title->postTitle }}</a>
                                @endforeach
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat43Title'] as $cat43Title)
                                <a href="{{ route('english_news_details', $cat43Title->id) }}"
                                    class="list-group-item">{{ $cat43Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat20Title'] as $cat20Title)
                                <a href="{{ route('english_news_details', $cat20Title->id) }}"
                                    class="list-group-item">{{ $cat20Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat6Title'] as $cat6Title)
                                <a href="{{ route('english_news_details', $cat6Title->id) }}"
                                    class="list-group-item">{{ $cat6Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat31Title'] as $cat31Title)
                                <a href="{{ route('english_news_details', $cat31Title->id) }}"
                                    class="list-group-item">{{ $cat31Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat32Title'] as $cat32Title)
                                <a href="{{ route('english_news_details', $cat32Title->id) }}"
                                    class="list-group-item">{{ $cat32Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            ...
                            @foreach ($news['cat21Title'] as $cat21Title)
                                <a href="{{ route('english_news_details', $cat21Title->id) }}"
                                    class="list-group-item">{{ $cat21Title->postTitle }}</a>
                            @endforeach
                    ...
                    <div class="box-card mt-2">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat24Title'] as $cat24Title)
                                <a href="{{ route('english_news_details', $cat24Title->id) }}"
                                    class="list-group-item">{{ $cat24Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            ...
                            @foreach ($news['cat23Title'] as $cat23Title)
                                <a href="{{ route('english_news_details', $cat23Title->id) }}"
                                    class="list-group-item">{{ $cat23Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                    <!--============================= education ===============================-->
                    <div class="box-card mt-2">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat25Title'] as $cat25Title)
                                <a href="{{ route('english_news_details', $cat25Title->id) }}"
                                    class="list-group-item">{{ $cat25Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat26Title'] as $cat26Title)
                                <a href="{{ route('english_news_details', $cat26Title->id) }}"
                                    class="list-group-item">{{ $cat26Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat27Title'] as $cat27Title)
                                <a href="{{ route('english_news_details', $cat27Title->id) }}"
                                    class="list-group-item">{{ $cat27Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                        ...
                        <div class="cat-body">
                            <div class="list-group no-margin">
                                @foreach ($news['cat30Title'] as $cat30Title)
                                    <a href="{{ route('english_news_details', $cat30Title->id) }}"
                                        class="list-group-item">{{ $cat30Title->postTitle }}</a>
                                @endforeach
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="cat-body">
                            <div class="list-group no-margin">
                                @foreach ($news['cat33Title'] as $cat33Title)
                                    <a href="{{ route('english_news_details', $cat33Title->id) }}"
                                        class="list-group-item">{{ $cat33Title->postTitle }}</a>
                                @endforeach
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            ...
                            @foreach ($news['cat42Title'] as $cat42Title)
                                <a href="{{ route('english_news_details', $cat42Title->id) }}"
                                    class="list-group-item">{{ $cat42Title->postTitle }}</a>
                            @endforeach
                    ...
                    <div class="box-card mt-2">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat37Title'] as $cat37Title)
                                <a href="{{ route('english_news_details', $cat37Title->id) }}"
                                    class="list-group-item">{{ $cat37Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat38Title'] as $cat38Title)
                                <a href="{{ route('english_news_details', $cat38Title->id) }}"
                                    class="list-group-item">{{ $cat38Title->postTitle }}</a>
                            @endforeach
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat39Title'] as $cat39Title)
                                <a href="{{ route('english_news_details', $cat39Title->id) }}"
                                    class="list-group-item">{{ $cat39Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat40Title'] as $cat40Title)
                                <a href="{{ route('english_news_details', $cat40Title->id) }}"
                                    class="list-group-item">{{ $cat40Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat41Title'] as $cat41Title)
                                <a href="{{ route('english_news_details', $cat41Title->id) }}"
                                    class="list-group-item">{{ $cat41Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat44Title'] as $cat44Title)
                                <a href="{{ route('english_news_details', $cat44Title->id) }}"
                                    class="list-group-item">{{ $cat44Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat45Title'] as $cat45Title)
                                <a href="{{ route('english_news_details', $cat45Title->id) }}"
                                    class="list-group-item">{{ $cat45Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat47Title'] as $cat47Title)
                                <a href="{{ route('english_news_details', $cat47Title->id) }}"
                                    class="list-group-item">{{ $cat47Title->postTitle }}</a>
                            @endforeach
                    ...
                    <div class="box-card">
                        ...
                        <div class="list-group no-margin">
                            @foreach ($news['cat48Title'] as $cat48Title)
                                <a href="{{ route('english_news_details', $cat48Title->id) }}"
                                    class="list-group-item">{{ $cat48Title->postTitle }}</a>
                            @endforeach
                        </div>
                    </div>
                </div> --}}
