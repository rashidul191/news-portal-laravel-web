            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    ...
                    <div class="date-time">
                        <span>
                            <span>
                                Dhaka, {{ \Carbon\Carbon::now()->setTimezone('Asia/Dhaka')->format('F j, Y, g:i a') }}
                            </span>
                            ...
                            <div class="social">
                                ...
                                <a href="{{ $basicInfo->twitter }}">
                                    <i class="fa-brands fa-twitter" style="color: #1DA1F2"></i>
                                </a>
                                <a href="{{ $basicInfo->youTubeLink }}">
                                    <i class="fa-brands fa-youtube" style="color: #FF0000"></i>
                                </a>
                                <a href="{{ $basicInfo->google }}">
                                    <i class="fa-brands fa-google-plus-g" style="color: #DD4F41"></i>
                                </a>
                                <a class="btn btn-sm btn-primary" href="{{ route('/') }}" target="_blank"
                                    style="margin-top: -10px;">বাংলা</a>
                            </div>
                        </span>
                    </div>
                    <!-- ====================== Google-Search ====================== -->
        ...
        <div class="container content-container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav" style="margin-left: -12px; margin-right: -12px;">
                <ul class="navbar-nav flex-wrap">
                    <li class="nav-item ">
                        <a class="nav-link {{ Request::is('english') ? 'active' : '' }}" aria-current="page"
                            href="{{ route('english') }}">
                            Home
                        </a>
                    </li>
                    ...
                    @foreach ($category as $c)
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('category/' . $c->id) ? 'active' : '' }}"
                                href="{{ route('english_category', $c->id) }}">{{ $c->name_eng }}</a>
                        </li>
                    @endforeach
                    <li class="nav-item ">
                        <a class="nav-link {{ Request::is('english_archive') ? 'active' : '' }}" aria-current="page"
                            href="{{ route('english_archive') }}">
                            Archive
                        </a>
                    </li>
                </ul>
